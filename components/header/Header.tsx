...
export function Header() {
  return (
    <header className="max-w-7xl mx-auto border-x border-b border-gray-200 bg-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <Button className="bg-[#3A9789] hover:bg-[#337f73] text-white font-medium px-4 py-2 rounded-md flex items-center gap-2 cursor-pointer">
